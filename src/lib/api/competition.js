...
// Start a round (legacy - kept for reference but use automated flow instead)
...
// End a round and eliminate losing group (legacy)
...
// Complete competition with final rankings (legacy)
